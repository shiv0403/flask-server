...
try:
    ...
    with ZipFile(filename, 'r') as zip_file:
        ...
        files_to_extract = [f for f in files if f.startswith(
        ...
        shutil.move(os.path.join(
            temp_path, 'models-master/research/object_detection/'), target_path)
...
try:
    subprocess.Popen(
        'protoc object_detection/protos/*.proto --python_out=.', shell=True)
